{{-- Profile Overlay — nur für eingeloggte User
...
<script>
    // Funktionen immer definieren — auch für Gäste (damit kein JS-Fehler entsteht
    // wenn der Button theoretisch irgendwo auftaucht)
    function openProfileOverlay() {
        const el = document.getElementById('profile-overlay');
        if (!el) return; // Gast: Overlay existiert nicht → still fail
